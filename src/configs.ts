...
export const applicationPort: number = sanitizeInteger(
...
export const concurrentDomainRequestLimit: number = sanitizeInteger(
	process.env.CONCURRENT_DOMAIN_REQUEST_LIMIT,
	3
);
// Maximum number of requests that can be queued for a domain
export const maxQueueLimitPerDomain: number = sanitizeInteger(
	process.env.MAX_QUEUE_LIMIT_PER_DOMAIN,
	10
);
...
export const retryDelay: number = sanitizeInteger(
